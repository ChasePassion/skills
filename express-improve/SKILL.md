...
1. **Vision**: You are working on a problem worth caring about, and you have a distinctive angle on it
2. **Done Something**: You do not just have ideas; you already have concrete results
...
* [ ] Does the opening include an empowerment promise? (Does the audience know why they should listen?)
* [ ] Does the core idea appear 2 to 3 times?
* [ ] Is it clear what this is *not*? (Have you drawn the boundary?)
* [ ] Are the contributions clearly enumerated?

**Delivery**

* [ ] Are there verbal signposts in the talk? (Can distracted listeners get back on?)
* [ ] Is there at least one question? (Does it create participation?)
* [ ] Does the talk convey genuine passion? (Not performance, but real investment)

**Slides**

* [ ] Is there little enough text on each slide?
* [ ] Is the font size at least 40pt?
* [ ] Is the last slide titled Contributions?
* [ ] Are collaborators listed on the first slide?

**Time and place**

* [ ] Have you checked the room in advance?
* [ ] Is the lighting bright enough?
* [ ] Are your practice listeners people who do *not* understand your research?

---

## IX. Workflow for Using This Skill

1. **State the scenario**: explain what kind of presentation it is, who the audience is, and how much time you have
2. **Provide existing material**: drafts, outlines, or even screenshots of slides are all useful
3. **State the goal**: explain what worries you most (weak opening, messy structure, hard to understand, hard to remember, etc.)
4. **outputs**: based on the scenario template and diagnostic principles, provide concrete structural revisions, wording suggestions, or a full draft